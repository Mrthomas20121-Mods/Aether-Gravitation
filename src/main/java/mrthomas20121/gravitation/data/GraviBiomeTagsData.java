...
public class GraviBiomeTagsData extends BiomeTagsProvider {

    public GraviBiomeTagsData(PackOutput p_255800_, CompletableFuture<HolderLookup.Provider> p_256205_, @Nullable ExistingFileHelper existingFileHelper) {
