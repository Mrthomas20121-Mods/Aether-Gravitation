...
public class GravitationBlockstateData extends AetherBlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        // aerfin set
        this.pottedPlant(GraviBlocks.POTTED_AERFIN_SAPLING.get(), GraviBlocks.AERFIN_SAPLING.get(), "natural/");
        this.pottedPlant(GraviBlocks.POTTED_BLUE_AERFIN_SAPLING.get(), GraviBlocks.BLUE_AERFIN_SAPLING.get(), "natural/");
        this.pottedPlant(GraviBlocks.POTTED_GOLDEN_AERFIN_SAPLING.get(), GraviBlocks.GOLDEN_AERFIN_SAPLING.get(), "natural/");
        ...
        // beladon set
        this.pottedPlant(GraviBlocks.POTTED_BELADON_SAPLING.get(), GraviBlocks.BELADON_SAPLING.get(), "natural/");
        ...
        // enchanted set
        this.pottedPlant(GraviBlocks.POTTED_ENCHANTED_SAPLING.get(), GraviBlocks.ENCHANTED_SAPLING.get(), "natural/");
