...
public class GravitationEntityTagsData extends ForgeEntityTypeTagsProvider {

    public GravitationEntityTagsData(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, ExistingFileHelper existingFileHelper) {
