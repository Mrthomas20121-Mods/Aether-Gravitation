...
public class BronziteArmorItem extends ArmorItem {
    private final List<Component> dungeonTooltips = new ArrayList<>();

    public BronziteArmorItem(ArmorMaterial material, ArmorItem.Type type, Properties properties) {
    ...
    public BronziteArmorItem addDungeonTooltip(Component dungeonTooltip) {
