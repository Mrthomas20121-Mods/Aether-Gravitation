...
public class EnchantedBoatItem extends Item {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final boolean hasChest;

    public EnchantedBoatItem(boolean hasChest, Item.Properties properties) {
        super(properties);
    ...
    /**
     * Gets a Enchanted Boat dependent on {@link EnchantedBoatItem#hasChest}.
     * @param level The {@link Level} of the boat.
     * @param hitResult The {@link HitResult} of attempting to place the boat.
     * @return The type of {@link Boat}, either a {@link EnchantedChestBoat} or a {@link EnchantedBoat}.
     */
    private Boat getBoat(Level level, HitResult hitResult) {
        return this.hasChest ? new EnchantedChestBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z) : new EnchantedBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z);
    }
}