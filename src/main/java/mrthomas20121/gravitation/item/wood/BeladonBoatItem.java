...
public class BeladonBoatItem extends Item {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final boolean hasChest;

    public BeladonBoatItem(boolean hasChest, Properties properties) {
        super(properties);
    ...
    /**
     * Gets a Enchanted Boat dependent on {@link BeladonBoatItem#hasChest}.
    ...
    private Boat getBoat(Level level, HitResult hitResult) {
        return this.hasChest ? new BeladonChestBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z) : new BeladonBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z);
    }
}